...
const page = () => {
  return (
    <div className=''>
      <div className="center max-w-screen-lg mx-auto py-10">
        <h1 className='md:text-4xl font-bold text-xl'>Amado E-commerce Project</h1>
        <p className='text-gray-500 mt-4 w-1/2'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium animi quod magni nihil repellat at recusandae repudiandae, facere qui eligendi fuga nulla dolore praesentium voluptatum saepe doloremque necessitatibus molestias atque!</p>
        ...
        <h3 className="text-xl font-bold uppercase">Project Link</h3>
         <h3 className="text-xl font-bold uppercase">see code</h3>
        </div>
        </div>
      </div>
